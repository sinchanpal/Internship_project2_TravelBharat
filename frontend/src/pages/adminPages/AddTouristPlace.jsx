...
import { LuMapPin, LuMap, LuBuilding2, LuImage, LuAlignLeft, LuX, LuTags } from "react-icons/lu";
...
const AddTouristPlace = () => {
    ...
    useEffect(() => {
        if (selectedState) {
            const fetchCities = async () => {
                try {
                    const response = await axios.get(`${serverUrl}/api/explore/cities-by-state/${selectedState}`, { withCredentials: true });
    ...
    const handleAddPlace = async (e) => {
        ...
        if (!name || !selectedState || !selectedCity || !category || !description || !coverImage) {
        ...
        try {
            ...
            setMessage({
                type: 'error',
                text: error.response?.data?.message || 'An error occurred while adding the tourist place.'
            });
        } finally {
            setLoading(false);
        }
        ...
        <div className="w-full">
            <div className="max-w-xl w-full bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden mx-auto mt-8">
                ...
                <form onSubmit={handleAddPlace} className="p-8 space-y-6">
                    ...
                    {/* Cascading Dropdowns: State then City */}
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <select
                                    ...
                                    className="block w-full pl-10 pr-3 py-3 border border-gray-200 rounded-xl text-gray-900 focus:outline-none focus:ring-2 focus:ring-green-500 bg-gray-50 focus:bg-white appearance-none"
                                    required
                                >
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <select
                                    ...
                                    className="block w-full pl-10 pr-3 py-3 border border-gray-200 rounded-xl text-gray-900 focus:outline-none focus:ring-2 focus:ring-green-500 bg-gray-50 focus:bg-white appearance-none disabled:bg-gray-100 disabled:text-gray-400"
                                    required
                                >
                                    <option value="" disabled>
                                        {!selectedState ? "Select a state first" : availableCities.length === 0 ? "No cities in this state" : "Select City..."}
                                    </option>
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="block w-full pl-10 pr-3 py-3 border border-gray-200 rounded-xl text-gray-900 focus:outline-none focus:ring-2 focus:ring-green-500 bg-gray-50 focus:bg-white"
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <textarea
                                ...
                                rows={4}
                                className="block w-full pl-10 pr-3 py-3 border border-gray-200 rounded-xl text-gray-900 focus:outline-none focus:ring-2 focus:ring-green-500 bg-gray-50 focus:bg-white resize-y"
